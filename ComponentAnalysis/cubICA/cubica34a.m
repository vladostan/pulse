...
% fourth-order cumulants simultaneously. This is an
% approximated version of comon34. 
%
%  [R,y]=cubica34a(x)
%
...
% For large N better peformance can be achieved by increasing
% the number of sweeps.(1+round(sqrt(N))
%
